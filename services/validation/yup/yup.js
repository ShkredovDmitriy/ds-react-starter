...
import { phoneRegex, ruOneRegex, ruTwoRegex, dateOneRegex, emailRegex, passwordRegex, numOneRegex } from './constants';
import checkPersonalInn, { checkInn10 } from './innRu';
  ...
  () => Yup.string().test({
    ...
    test: value => {
      ...
      if (R.is(String, value)) {
        ...
        return checkPersonalInn(innList) || checkInn10(innList);
      }
...
Yup.addMethod(
  Yup.string,
  'passwordEqual',
  (ref) => Yup.string().oneOf([ref], i18nLocale.string.password_equal),
);
